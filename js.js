// Initialize Bootstrap Carousel (only if carousel exists)
...
// Navbar toggle functionality (always collapsed style)
...
document.querySelectorAll('#HotCoffee, #IceCoffee, #Latte, #Frappes, #MilkShakes, #Smoothies, #Mojitos, #RedBull, #IceTea, #Juices, #IceCream, #Crepes, #MiniPancakes, #Desserts').forEach(section => {
